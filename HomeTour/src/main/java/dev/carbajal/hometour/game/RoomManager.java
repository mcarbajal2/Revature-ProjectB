	...
	public void init() {
		...
		Room living = new Room ("Living Room", 
				...
				"At the very center of the area a couch you can feel yourself sinking \n"
						...
						+ "sturdy-looking coffee table and a rug with a rather...interesting"
						+ "pattern.");
		...
		Room bed = new Room ("First Bedroom", 
				"Another bedroom.", 
				"A decent-sized bedroom that could also be turned into a home office, a gym, \n"
						+ "etc. if desired!");
		
		Room bath = new Room ("Bathroom 1", 
				"The bedroom's bathroom.", 
				"Adjacent to the bedroom, a bathroom with a shower and quaint furnishings.");
